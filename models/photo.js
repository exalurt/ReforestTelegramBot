...
module.exports = function(sequelize, DataTypes) {
  var Photo = sequelize.define('Photo', {
    ...
    agents_Successfully_Recruited: DataTypes.INTEGER,
    ...
    largest_Control_Field: DataTypes.INTEGER,
    largest_Field_MUs_x_Days: DataTypes.INTEGER,
    links_Created: DataTypes.INTEGER,
    longest_Hacking_Streak: DataTypes.INTEGER,
    longest_Link_Ever_Created: DataTypes.INTEGER,
    max_Link_Length_x_Days: DataTypes.INTEGER,
    max_Time_Field_Held: DataTypes.INTEGER,
    max_Time_Link_Maintained: DataTypes.INTEGER,
    max_Time_Portal_Held: DataTypes.INTEGER,
    mind_Units_Captured: DataTypes.INTEGER,
    mods_Deployed: DataTypes.INTEGER,
    portals_Captured: DataTypes.INTEGER,
    portals_Discovered: DataTypes.INTEGER,
    ...
    unique_Portals_Visited: DataTypes.INTEGER,
